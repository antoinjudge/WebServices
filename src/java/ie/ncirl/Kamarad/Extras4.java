...
import static ie.ncirl.Kamarad.ExtraOption2.DB_URL;
import static ie.ncirl.Kamarad.ExtraOption3.DB_URL;
 ...
 * @author Antoin
 */
@WebService(serviceName = "Extras4")
@Stateless()
public class Extras4 {
     ...
     */
    @WebMethod(operationName = "extras4")
    public String Extras(String numberIn, int numKam) {
        ...
        try {
            ...
            sql = "UPDATE CUSTOMERS SET EVERYONE500 =  EVERYONE500 + " + numKam + " WHERE PHONENUMBER = " + numberIn + "";
